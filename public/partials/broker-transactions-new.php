...
<div class="realty-workstation-pro-agents-all">
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0"><?php _e( 'Add New Broker Transaction', 'realty-workstation-pro' ); ?></h6>
        </div>
        <div class="card-body">
            <form method="POST" action="<?php echo admin_url('admin-post.php'); ?>">
                ...
                <div class="button-group">
                    <button type="button" class="btn btn-success w-25 add-new-broker-transaction-btn">Save</button>
                </div>
            </form>
        </div>
    </div>
