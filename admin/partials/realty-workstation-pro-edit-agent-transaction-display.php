...
<div class="wrap realty-workstation-pro-settings-div edit-transaction-container">
    <div class="rw-card">
        <div class="rw-card-header">
            <h2 class="wp-heading-inline"><?php _e( 'Update Agent Transaction', 'realty-workstation-pro' ); ?></h2>
        </div>
        <div class="rw-card-body">
            <form method="POST" action="<?php echo admin_url('admin-post.php'); ?>">
                ...
                <div class="button-group">
                    <button type="button" class="rw-button update-agent-transaction-btn">Save</button>
                    <button type="button" class="rw-button close-agent-transaction-btn">Close and Request Payment</button>
                </div>
            </form>
        </div>
    </div>
