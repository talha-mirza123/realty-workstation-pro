...
<div class="wrap realty-workstation-pro-settings-div">
    <div class="rw-card">
        <div class="rw-card-header">
            <h2 class="wp-heading-inline"><?php _e( 'Add New Agent Transaction', 'realty-workstation-pro' ); ?></h2>
        </div>
        <div class="rw-card-body">
            <form method="POST" action="<?php echo admin_url('admin-post.php'); ?>">
                ...
                <div class="button-group">
                    <button type="button" class="rw-button add-new-agent-transaction-btn">Save</button>
                </div>
            </form>
        </div>
    </div>
