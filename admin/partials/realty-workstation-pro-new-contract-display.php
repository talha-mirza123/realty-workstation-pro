<div class="wrap realty-workstation-pro-settings-div add-contract-container">
    <div class="rw-card">
        <div class="rw-card-header">
            <h2 class="wp-heading-inline"><?php _e( 'Add New Contract', 'realty-workstation-pro' ); ?></h2>
        </div>
        <div class="rw-card-body">
            <form method="POST" action="<?php echo admin_url('admin-post.php'); ?>">
                ...
                <div class="button-group">
                    <button type="button" class="rw-button add-new-contract-btn">Save</button>
                </div>
            </form>
        </div>
    </div>
